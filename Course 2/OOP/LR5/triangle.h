...
class tTriangle : public tPoint
{
	...
	public:
		...
		virtual void setV1X(float c, float fi = 0);
		virtual void setV1Y(float c, float fi = 0);
		virtual void setV2X(float c, float fi = 0);
		virtual void setV2Y(float c, float fi = 0);
		virtual void setV3X(float c, float fi = 0);
		virtual void setV3Y(float c, float fi = 0);
